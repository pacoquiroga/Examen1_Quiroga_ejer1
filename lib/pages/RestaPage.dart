...
class RestaPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => RestaPageState();
}

class RestaPageState extends State<RestaPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Resta de dos Números'),
