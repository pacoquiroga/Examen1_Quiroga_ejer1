...
class MultiplicacionPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => MultiplicacionPageState();
}

class MultiplicacionPageState extends State<MultiplicacionPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Multiplicación de dos Números'),
